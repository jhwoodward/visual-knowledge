...
.directive('bootstrapTagsinput', [function () {
    ...
    return {
        ...
        scope: {
            model: '=ngModel',
            typeaheadSource: '=',
            node:'=' //TODO: REMOVE NODE DEPENDENCY AND FIGURE OUT HOW TO PASS FUNCTION IN FOR TAG CLASS
        },
...
//                console.log(attrs.tagclass);
//console.log(scope.$parent.getTagClass());
                var textprop = attrs["itemtext"];
                var valprop = attrs["itemvalue"];
                ...
                select.tagsinput({
                 ...
                 //   tagClass: angular.isFunction(scope.$parent[attrs.tagclass]) ? scope.$parent[attrs.tagclass] : function (item) { return attrs.tagclass; }
                    tagClass:  function (item) {return item == scope.node.Type ? 'label label-warning' : 'label label-info' }
                });
